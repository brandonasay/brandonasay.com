        ...
        <div className="flex gap-5 items-start">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2 mb-3">
              <div>
                <h4 className="text-white font-bold text-lg leading-tight">The Watchmaker</h4>
            ...
            <ul className="space-y-2">
              {[
                ...
                "All proceeds fund the Watchmaker Foundation, a nonprofit removing financial barriers for exceptional creators.",
                "Founded the Foundation to make the mission permanent.",
              ].map((b, i) => (
