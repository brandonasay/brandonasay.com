  ...
  return (
    <div className="px-4 sm:px-6 pb-10 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <Tile label="Claude Code, Vercel, and Supabase Projects" color={COLORS.projects}  className="md:col-start-1 md:col-span-3 md:row-start-3">
          <ProjectsContent />
        </Tile>
        <Tile label="Hobbies & Interests"  color={COLORS.hobbies}   className="md:col-start-1 md:col-span-3 md:row-start-4">
          <HobbiesContent />
        </Tile>
      </div>
    </div>
